...
def translate_column_names():
    ...
    cursor.execute("INSERT INTO translations VALUES ('3', 'Begünstigter / Auftraggaber', 'Recipient', '' )")
    ...
    cursor.execute("INSERT INTO translations VALUES ('10', 'Abweichender Empfänger', 'Alternative Recipient', '' )")
